window.UJOS_RESUME_DATA = {
  ...
  "variants": {
    ...
    "cloud": {
      ...
      "summary": "Cloud-focused engineer building GitHub-backed AWS workflows with Lambda, S3, DynamoDB, API Gateway, Cognito, Textract, IAM, and CloudFront. Strong at connecting identity, storage, processing, API layers, and frontend delivery into usable product workflows with clear service boundaries.",
      "coreStrengths": [
  ...
  "projects": [
    ...
    },
    {
      ...
      "status": "GitHub",
      "summary": "Cloud-first personal safety platform with trusted circles, live trip monitoring, and SOS escalation across web and Android surfaces.",
      "stack": [
        "React",
        "Vite",
        "Node.js",
    ...
    },
    {
      ...
      "status": "Live + GitHub",
      "summary": "Repo-driven portfolio system with static-safe runtime data, project routing, command navigation, compare studio, and role-specific resume pack.",
      "stack": [
        "HTML",
        "CSS",
        "JavaScript",
